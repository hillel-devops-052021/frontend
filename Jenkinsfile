void Deploy(env_type) {
    withEnv (
        ...
        withCredentials (
            ...
            sh 'docker service create --with-registry-auth --name frontend -p 80:80 $registry/frontend:$BUILD_NUMBER || docker service update --image $registry/frontend:$BUILD_NUMBER frontend'
